package com.mvvm.kipl.mvvmdemo.base.itemdecorator;
...
public class HeaderDecoration2 extends RecyclerView.ItemDecoration {

    private View mLayout;

    public HeaderDecoration2(final Context context, RecyclerView parent, @LayoutRes int resId) {
